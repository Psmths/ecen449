...
#SWITCHES (BITS 0 - 3)
set_property PACKAGE_PIN G15 [ get_ports { buttons_tri_i[4]}]
set_property IOSTANDARD LVCMOS33 [ get_ports { buttons_tri_i[4]}]

set_property PACKAGE_PIN P15 [ get_ports { buttons_tri_i[5]}]
set_property IOSTANDARD LVCMOS33 [ get_ports { buttons_tri_i[5]}]

set_property PACKAGE_PIN W13 [ get_ports { buttons_tri_i[6]}]
set_property IOSTANDARD LVCMOS33 [ get_ports { buttons_tri_i[6]}]

set_property PACKAGE_PIN T16 [ get_ports { buttons_tri_i[7]}]
