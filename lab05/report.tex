...
\begin{document}
    ...
    {\noindent\Huge Questions\\\\}
        \begin{enumerate}
            \item{I do not see any reason the board shouldn't be power cycled. The mnt directory is the only directory touched and it will still exist after a reboot.}
