proc create_ipi_design { offsetfile design_name } {
	...
	set offset_file "${bd_path}/multiply_v1_0_tb_include.vh"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:multiply:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/multiply_v1_0_tb.v
